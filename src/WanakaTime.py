    ...
    def plant(self):
        ...
        while option != 'back':
            ...
            if option == 'cabbage' or option == 'repollo':
                ...
                print(f" Riegos: {self.times_apple[0]} || {self.times_apple[1]} || {self.times_apple[2]}")
                print(f" Cosecha: {self.times_apple[3]}")
                print()
    ...
    def save(self):
        with open("wanaka.txt", "a") as file_object:
            ...
            if len(self.times_apple) > 0:
                file_object.write(
                    f"Manzana: \n Riegos: {self.times_apple[0]} || {self.times_apple[1]} || {self.times_apple[2]} \n Cosecha: {self.times_apple[3]} \n")
